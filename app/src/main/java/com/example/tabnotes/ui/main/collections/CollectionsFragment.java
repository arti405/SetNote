package com.example.tabnotes.ui.main.collections;
...
import com.example.tabnotes.data.CollectionEntity;
        ...
        new androidx.appcompat.app.AlertDialog.Builder(requireContext())
                ...
                .setPositiveButton("Create", (d, w) -> {
                    ...
                    com.example.tabnotes.data.DbExecutors.IO.execute(() -> {
                        com.example.tabnotes.data.CollectionEntity c = new com.example.tabnotes.data.CollectionEntity();
                        c.name = finalName;
