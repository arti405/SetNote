...
public class HomeFragment extends Fragment {
    ...
    private void showHomeCreateDialog() {
        ...
        new androidx.appcompat.app.AlertDialog.Builder(requireContext())
                ...
                .setItems(options, (dialog, which) -> {
                    if (which == 0) {
                        ((com.example.setnote.MainActivity) requireActivity()).createSessionAutoFolderAndOpenEditor();
                    } else if (which == 1) {
                        ((com.example.setnote.MainActivity) requireActivity()).showTemplatePicker();
                    }
                })
                .show();
    }
    private void showSessionMenu(View anchor, com.example.setnote.data.SessionEntity session) {
    ...
    private void showRenameDialog(com.example.setnote.data.SessionEntity session) {
    ...
    private void showDeleteDialog(com.example.setnote.data.SessionEntity session) {
        new androidx.appcompat.app.AlertDialog.Builder(requireContext())
