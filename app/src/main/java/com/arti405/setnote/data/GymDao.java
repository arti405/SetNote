...
public interface GymDao {
    ...
    @Query("SELECT * FROM sessions ORDER BY dateEpochMillis DESC")
    java.util.List<SessionEntity> getAllSessionsNow();

    @Query("SELECT * FROM exercises ORDER BY position ASC")
    java.util.List<ExerciseEntity> getAllExercisesNow();

    @Query("SELECT * FROM sets ORDER BY position ASC")
    java.util.List<SetEntity> getAllSetsNow();

    @Query("SELECT * FROM templates ORDER BY createdAt DESC")
    java.util.List<TemplateEntity> getAllTemplatesNow();

    @Query("SELECT * FROM template_exercises ORDER BY position ASC")
    java.util.List<TemplateExerciseEntity> getAllTemplateExercisesNow();

    @Query("SELECT * FROM template_sets ORDER BY position ASC")
    java.util.List<TemplateSetEntity> getAllTemplateSetsNow();

    @Query("SELECT * FROM folders ORDER BY createdAt DESC")
    java.util.List<FolderEntity> getAllFoldersNow();

    @Query("SELECT * FROM collections ORDER BY createdAt DESC")
    java.util.List<CollectionEntity> getAllCollectionsNow();

    @Query("SELECT * FROM collection_sessions ORDER BY position ASC")
    java.util.List<CollectionSessionEntity> getAllCollectionSessionsNow();
